...
- GitHub [private vulnerability reporting](https://github.com/Akam1123/promiseledger/security/advisories/new) was enabled on the earlier PromiseLedger repository for software security findings. The new Duekrio repository exists, but its private reporting setting and link need a separate live check. A private customer/privacy request channel and accountable operator details have **not yet been established**; public GitHub Issues are unsuitable for confidential customer reports. This remains a release limitation recorded in [LEGAL_RISK_REVIEW.md](LEGAL_RISK_REVIEW.md).
