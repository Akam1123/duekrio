...
- GitHub [private vulnerability reporting](https://github.com/Akam1123/duekrio/security/advisories/new) was enabled and read back on the Duekrio repository for software security findings. A private customer/privacy request channel and accountable operator details have **not yet been established**; public GitHub Issues are unsuitable for confidential customer reports. This remains a release limitation recorded in [LEGAL_RISK_REVIEW.md](LEGAL_RISK_REVIEW.md).
