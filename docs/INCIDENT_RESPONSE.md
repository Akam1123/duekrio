...
- A private security and privacy contact has **not yet been established**. This is a release limitation recorded in [LEGAL_RISK_REVIEW.md](LEGAL_RISK_REVIEW.md); public GitHub Issues are unsuitable for confidential reports. Add a verified private channel and real operator details before inviting confidential records or paid customers.
