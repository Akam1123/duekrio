  ...
  return <div className="app-shell">
    ...
    <main className="app-main wrap">
      ...
      {!invoices.length ? <div className="empty-workspace">
        ...
        <div className="empty-foot"><a href={`${import.meta.env.BASE_URL}sample-ar-aging.csv`} download>Download sample CSV <ArrowDownToLine size={15} /></a><span /> <button onClick={() => restoreInput.current?.click()}>Restore a JSON backup <ArrowRight size={15} /></button></div>
      </div> : <>
